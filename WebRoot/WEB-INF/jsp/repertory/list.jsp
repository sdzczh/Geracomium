...
<body>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-qrcode"></i> 库存管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="${domain}/repertory/get.action" class="active-menu">仓库管理</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
                        <h1 class="page-header">
                            	库存管理	 <small>仓库管理</small>
                        </h1> 
						<ol class="breadcrumb">
					  <li><a style="text-decoration:none" onClick="add()" href="javascript:;" class='btn btn-danger' title="添加仓库">添加仓库</a></li>
					</ol> 
	...
	function del(id){
		...
		$.ajax({
			type: 'POST',
			url: '${domain}/repertory/del.action',
			data: {id : id},
	...
	function edit(id,uname,pwd){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/repertory/toUpdate.action?&id='+id,
		    end: function () {
		       location.reload();
		    }
		});
	...
	function add(){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/repertory/toAdd.action',
		    end: function () {
		       location.reload();
		    }
		});
