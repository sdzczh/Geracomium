...
<body>
                ...
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="${domain}/bed/get.action" class="active-menu">床位管理</a>
                            </li>
                            <li>
	...
	function edit(id,uname,pwd){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/bed/toUpdate.action?&id='+id,
		    end: function () {
		       location.reload();
		    }
		});
	...
	function add(){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/bed/toAdd.action',
		    end: function () {
		       location.reload();
		    }
		});
