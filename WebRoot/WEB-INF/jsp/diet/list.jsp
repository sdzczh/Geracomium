...
<body>
                   ...
                   <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="${domain}/diet/get.action" class="active-menu">饮食管理</a>
                            </li>
						</ul>
                    </li>
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
                        <h1 class="page-header">
                            	服务管理	 <small>饮食管理</small>
                        </h1> 
						<ol class="breadcrumb">
					  <li><a style="text-decoration:none" onClick="add()" href="javascript:;" class='btn btn-danger' title="添加护工">添加饮食</a></li>
					</ol> 
	...
	function edit(id,uname,pwd){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/diet/toUpdate.action?&id='+id,
		    end: function () {
		       location.reload();
		    }
		});
	...
	function add(){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/diet/toAdd.action',
		    end: function () {
		       location.reload();
		    }
		});
