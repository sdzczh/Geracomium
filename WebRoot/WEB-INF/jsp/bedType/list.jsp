...
<body>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-qrcode"></i> 床位管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="${domain}/bed/get.action">床位管理</a>
                            </li>
                            <li>
                                <a href="${domain}/bedType/get.action" class="active-menu">床位类型管理</a>
                            </li>
						</ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
                        <h1 class="page-header">
                            	床位管理	 <small>床位类型管理</small>
                        </h1> 
						<ol class="breadcrumb">
					  <li><a style="text-decoration:none" onClick="add()" href="javascript:;" class='btn btn-danger' title="添加员工">添加床位</a></li>
					</ol> 
	...
	function edit(id,uname,pwd){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/bedType/toUpdate.action?&id='+id,
		    end: function () {
		       location.reload();
		    }
		});
	...
	function add(){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/bedType/toAdd.action',
		    end: function () {
		       location.reload();
		    }
		});
