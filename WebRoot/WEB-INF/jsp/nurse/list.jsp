...
<body>
    <div id="wrapper">
                   ...
                   <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="${domain}/nurse/get.action" class="active-menu">护工管理</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
						...
						<ol class="breadcrumb">
					  <li><a style="text-decoration:none" onClick="add()" href="javascript:;" class='btn btn-danger' title="添加护工">添加护工</a></li>
					</ol> 
	...
	function edit(id,uname,pwd){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/nurse/toUpdate.action?&id='+id,
		    end: function () {
		       location.reload();
		    }
		});
	...
	function add(){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/nurse/toAdd.action',
		    end: function () {
		       location.reload();
		    }
		});
