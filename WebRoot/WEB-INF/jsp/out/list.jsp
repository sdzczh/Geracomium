...
<body>
                   ...
                   <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="${domain}/out/get.action" class="active-menu">外出登记</a>
                            </li>
                            <li>
	...
	function edit(id,uname,pwd){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/out/toUpdate.action?&id='+id,
		    end: function () {
		       location.reload();
		    }
		});
	...
	function add(){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/out/toAdd.action',
		    end: function () {
		       location.reload();
		    }
		});
