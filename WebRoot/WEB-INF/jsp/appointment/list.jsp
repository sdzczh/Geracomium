...
<body>
                ...
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="${domain}/appointment/get.action" class="active-menu">预约登记</a>
                            </li>
						</ul>
                    </li>
                    <li>
	...
	function del(id){
		...
		$.ajax({
			type: 'POST',
			url: '${domain}/appointment/del.action',
			data: {id : id},
	...
	function edit(id,uname,pwd){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/appointment/toUpdate.action?&id='+id,
		    end: function () {
		       location.reload();
		    }
		});
	...
	function add(){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/appointment/toAdd.action',
		    end: function () {
		       location.reload();
		    }
		});
