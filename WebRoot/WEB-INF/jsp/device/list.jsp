...
<body>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-qrcode"></i> 服务管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="${domain}/device/get.action" class="active-menu">设备管理</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
                        <h1 class="page-header">
                            	服务管理	 <small>设备管理</small>
                        </h1> 
						<ol class="breadcrumb">
					  <li><a style="text-decoration:none" onClick="add()" href="javascript:;" class='btn btn-danger' title="添加设备">添加设备</a></li>
					</ol> 
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" data-toggle="table" >
                                    ...
                                    <c:forEach var="list" items="${data}">
                                        <tr class="odd gradeX">
                                            ...
                                            <td>${list.uname }</td>
                                            <td>
												<c:if test="${list.state==0 }">未使用</c:if>
                                            	<c:if test="${list.state==1 }">已使用</c:if>
											</td>
	...
	function edit(id,uname,pwd){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/device/toUpdate.action?&id='+id,
		    end: function () {
		       location.reload();
		    }
		});
	...
	function add(){
		parent.layer.open({
		    ...
		    shade: 0.8,
		    area: ['600px', '60%'],
		    content: '${domain}/device/toAdd.action',
		    end: function () {
		       location.reload();
		    }
		});
